...
- [ ] R-0147: 案件一覧にステータス全種類のフィルタボタンを追加。仕様: `docs/spec/R-0147_project_list_status_filter.md`。/readyoubouで本番id=49を確認。バックエンドの`status=キャンセル`矛盾条件バグも同時発見・修正対象。Agent実装完了、指揮役の裏取り待ち
