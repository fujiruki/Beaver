...
- 発行: Beaver開発AI（R-0117 B1完了時点、2026-08-25）
- Beaver側仕様: `Beaverリポジトリ docs/spec/R-0117_youkan_integration_b1.md`
- 計画書: `docs/2026-08-25_Beaver-Youkan連携開発計画.md`
- 契約バージョン: B1（後方互換の追加はB2/B3で行う。破壊的変更時は本文書を改版）
...
- Beaver→Youkanへの保存時push（B2。それまではYoukan側のポーリングで拾う）
- Youkanの容量判定結果のBeaver表示（B2）
- 見積内訳の作業パッケージ公開（B3、`work_packages`フィールドを後方互換で追加予定）
