...
| 2026-08-05 | R-0095/R-0097: 案件の完全削除・工数目安 | 仕様化済み | R-0080フィードバック（id=11）より。伝票紐づき案件も完全削除可能（ただし請求書紐づきは保護）、見積伝票集計/手動入力の工数目安を案件一覧・ダッシュボードに反映。詳細仕様: `docs/spec/R-0095_R-0097_project_delete_and_hours.md` |
| 2026-08-06 | R-0096: システム全体の「戻る」ボタン対応 | 検討開始 | 藤田晴樹さん指定（2026-08-06以降着手）。Fable視点も交えた設計検討を開始。詳細: `docs/requests.md` R-0096節 |
