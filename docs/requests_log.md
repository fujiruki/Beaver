...
| 2026-08-05 | R-0083: 検索の複数プロパティ対応 Phase1（得意先 + ComboSelect共通化） | 仕様化済み | 同上フィードバックより。ComboSelectのEnter選択修正（全利用箇所に波及）＋得意先検索対象を読み・電話番号・住所・備考へ拡張。他画面への横展開はPhase2としてバックログ（R-0084）へ。詳細仕様: `docs/spec/R-0083_search_multi_property.md` |
