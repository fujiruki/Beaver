...
$betaOnlyMigrations  = @("028_voucher_lines_quantity_real.sql", "034_projects_deleted_at.sql", "030_vouchers_access_billed_flag.sql", "031_invoices_access_fields.sql", "032_payments_access_fields.sql", "035_sync_state_heartbeat.sql", "036_invoices_payments_updated_at.sql")
